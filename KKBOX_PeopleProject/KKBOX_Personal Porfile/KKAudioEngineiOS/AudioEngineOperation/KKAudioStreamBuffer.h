...
- (nonnull instancetype)initWithMaximumPacketCount:(size_t)inCount;
- (void)storePacketData:(nonnull const void *)inData count:(size_t)inPacketCount descriptions:(nonnull AudioStreamPacketDescription *)inPacketDescriptions;
